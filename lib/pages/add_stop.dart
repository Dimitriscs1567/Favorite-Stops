...
class AddStop extends StatelessWidget {
                ...
                children: [
                  ...
                  GetX<NewDataController>(
                    builder: (controller) {
                      ...
                      } else if (controller.loadingBuses.value) {
                        return Center(
                          child: CircularProgressIndicator(),
                        );
                      } else if (controller.allBuses.isEmpty) {
                        return Container(
                          child: Text(
                            "There are no available buses from this stop!",
                            style: TextStyle(fontSize: 20.0),
                          ),
                        );
                      }
  ...
  Widget _getBusesAsWidget() {
    ...
    return SearchableDropdown.multiple(
      selectedItems: controller.selectedBuses,
      items: controller.allBuses.map((bus) {
      ...
      onChanged: (values) {
        controller.selectedBuses.clear();
        controller.selectedBuses.addAll(values);
      },
    );
  }
